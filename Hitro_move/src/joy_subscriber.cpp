...
target.linear.x=L2;//L2
target.linear.y=R2;//R2
...
button_array.data[0]=ps5_msg->L1;//L1
button_array.data[1]=ps5_msg->R1;//R1
button_array.data[2]=ps5_msg->Triangle;//Square
button_array.data[3]=ps5_msg->Circle;//Triangle
button_array.data[4]=ps5_msg->Square;//Cross
button_array.data[5]=ps5_msg->L2Button;//L2
button_array.data[6]=ps5_msg->R2Button;//R2
button_array.data[7]=ps5_msg->SHARE;//SHARE
button_array.data[8]=ps5_msg->OPTION;//OPTION
button_array.data[9]=ps5_msg->R3;//L3
button_array.data[10]=ps5_msg->PSButton;//R3
button_array.data[11]=ps5_msg->L3;//PSButton
button_array.data[12]=ps5_msg->Cross;//Circle
