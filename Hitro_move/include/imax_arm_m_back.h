...
namespace std{};
class imax_arm_m_back
{
public:
  imax_arm_m_back(int motor_number){
        sub_ps5= nh.subscribe("/cmd_vel", 1,&imax_arm_m_back::joy2xyz,this);
        sub_button=nh.subscribe("/cmd_button", 1,&imax_arm_m_back::msg_button,this);
        // sub_ps5= nh.subscribe("/cmd_vel", 1,&imax_arm_m_back::urdf_check,this);
