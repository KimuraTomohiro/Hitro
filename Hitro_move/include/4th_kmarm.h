...
{
public:
  km_arm_4th(int motor_number){
        sub_ps5= nh.subscribe("/cmd_vel", 1,&km_arm_4th::joy2xyz,this);
        sub_button=nh.subscribe("/cmd_button", 1,&km_arm_4th::msg_button,this);
        // sub_ps5= nh.subscribe("/cmd_vel", 1,&km_arm_4th::urdf_check,this);
    ...
    // else{
        ...
        joint_rad_urdf.name.resize(9);
        joint_rad_urdf.position.resize(9);
        ...
        joint_rad_urdf.name[8]="th_camera";
...
private:
    ...
    float joy_mass=0.001f;//joyによるxyz_eeの変化量
