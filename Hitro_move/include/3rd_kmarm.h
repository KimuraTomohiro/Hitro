...
{
public:
  km_arm_3rd(int motor_number){
        sub_ps5= nh.subscribe("/cmd_vel", 1,&km_arm_3rd::joy2xyz,this);
        sub_button=nh.subscribe("/cmd_button", 1,&km_arm_3rd::msg_button,this);
        // sub_ps5= nh.subscribe("/cmd_vel", 1,&km_arm_3rd::urdf_check,this);
